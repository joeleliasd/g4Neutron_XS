...
HadPhysicsListMessenger::HadPhysicsListMessenger(HadPhysicsList* pPhys)
:pPhysicsList(pPhys)
{   
...
HadPhysicsListMessenger::~HadPhysicsListMessenger()
{
  delete gammaCutCmd;
  delete electCutCmd;
  delete posCutCmd;
...
void HadPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
